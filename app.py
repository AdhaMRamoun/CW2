...
#configuration of the mysql data, please note that each device hosting mysql will have a diffrent user and password
...
def transaction():
    ...
    if request.method == 'POST':
        try:
            ...
            flash("PyCoin Sucessfully Sent!", "success")
...
def buy():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            flash("Purchase Rendered Successful!", "success")
        except Exception as e:
            flash(str(e), 'danger')
