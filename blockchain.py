#to use sha256 hash for the hashing of the blockchain
...
class Blockchain():
    ...
    #appending a new block to the chain
    def add(self, block):
    ...
    #find the nonce of the block that matches the difficulty and add to chain
    def mine(self, block):
        #attempt to get the hash of the previous block.
        #thiswill result in an error because the first block has no previous hash.
